...
{
public:
	/* konstruktør som initialiserer to baller til predefinerte verdier */
	mcubes_metaballs()
	{
		num_metapoints = 2;
	...
	/* setter verdien for hvor grensen mellom ball og ikke ball skal gå */
	...
	/*	returnerer et punkt som er interpolert mellom to andre punkter, 
		både for normaler og for posisjon.
	*/
	inline vertex interpolate(vertex v1, vertex v2)
	{
		...
		/* regner ut en gjennomsnittsnormal ut fra normalene på de enkelte punktene */
